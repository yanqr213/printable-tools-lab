...
Last generated: 2026-06-05T22:40:52.090Z
...
- GitHub Pages discovery directory is live with 92 landing page link(s), 66 tool mirror link(s), and 1 game submission link(s).
- GitHub Pages discovery sitemap has 168 URL(s), including 66 tool mirror URL(s) and 3 game submission URL(s); expected at least 168.
- IndexNow key file is reachable from the site root.
- IndexNow latest report accepted 168 URL(s) for github-pages.
