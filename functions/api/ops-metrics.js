...
const PROJECTS = [
  {
    ...
    paths: ["/", "/invoice-followup-copy-pack/", "/upload-limit-fix-plan/", "/polite-payment-reminder-email/", "/freelance-invoice-follow-up-email/", "/overdue-invoice-reminder-email/", "/tools/invoice-followup-email/", "/tools/invoice-generator/", "/free-pdf-tools/", "/pdf-tool-finder/", "/sponsor/", "/sponsor-call/", "/sponsor-opportunities/", "/tools/compress-pdf/", "/tools/qr-code/", "/upload-limit-fixer/", "/custom-local-print-pack/", "/market-table-print-audit/", "/local-seller-starter-kit/"],
  },
  {
