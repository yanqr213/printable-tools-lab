...
const exactUploadLimitBacklog = [
  ["compress-pdf-to-100kb", "Compress PDF to 100KB", "pdf_100kb_2026_06", "compress_pdf_to_100kb_landing", "Free no-signup browser PDF compressor for very strict 100KB upload limits. It opens the local PDF compressor with a 100KB target and gives users a public-safe upload-limit workflow before submitting elsewhere.", "No signup. Browser-based PDF compression. Exact 100KB target. No ordinary server upload. Free download path. Public-safe upload notes."],
  ["compress-pdf-to-200kb", "Compress PDF to 200KB", "pdf_200kb_2026_06", "compress_pdf_to_200kb_landing", "Free no-signup browser PDF compressor for strict 200KB upload limits. It opens the local PDF compressor with a 200KB target and helps users check the downloaded file before uploading elsewhere.", "No signup. Browser-based PDF compression. Exact 200KB target. No ordinary server upload. Free download path. Public-safe upload notes."],
  ["compress-pdf-to-300kb", "Compress PDF to 300KB", "pdf_300kb_2026_06", "compress_pdf_to_300kb_landing", "Free no-signup browser PDF compressor for strict 300KB upload limits where readability needs a little more room than 100KB or 200KB.", "No signup. Browser-based PDF compression. Exact 300KB target. No ordinary server upload. Free download path. Public-safe upload notes."],
  ["compress-pdf-to-10mb", "Compress PDF to 10MB", "pdf_10mb_2026_06", "compress_pdf_to_10mb_landing", "Free no-signup browser PDF compressor for wider 10MB upload limits on email, support, school, and document portals that still reject large scans.", "No signup. Browser-based PDF compression. Exact 10MB target. No ordinary server upload. Free download path. Public-safe upload notes."],
  ["pdf-must-be-under-100kb", "PDF Must Be Under 100KB Fix", "pdf_under_100kb_upload_fix_2026_06", "pdf_must_be_under_100kb_landing", "Free no-signup upload-error page for forms that say a PDF must be under 100KB. It routes users to the local PDF compressor with the 100KB target selected.", "No signup. Exact upload-error wording. Browser-based PDF compression path. 100KB target. Public-safe notes only. Free tool before any optional service request."],
  ["pdf-must-be-under-200kb", "PDF Must Be Under 200KB Fix", "pdf_under_200kb_upload_fix_2026_06", "pdf_must_be_under_200kb_landing", "Free no-signup upload-error page for forms that say a PDF must be under 200KB. It routes users to the local PDF compressor with the 200KB target selected.", "No signup. Exact upload-error wording. Browser-based PDF compression path. 200KB target. Public-safe notes only. Free tool before any optional service request."],
  ["pdf-must-be-under-300kb", "PDF Must Be Under 300KB Fix", "pdf_under_300kb_upload_fix_2026_06", "pdf_must_be_under_300kb_landing", "Free no-signup upload-error page for forms that say a PDF must be under 300KB. It routes users to the local PDF compressor with the 300KB target selected.", "No signup. Exact upload-error wording. Browser-based PDF compression path. 300KB target. Public-safe notes only. Free tool before any optional service request."],
  ["pdf-must-be-under-10mb", "PDF Must Be Under 10MB Fix", "pdf_under_10mb_upload_fix_2026_06", "pdf_must_be_under_10mb_landing", "Free no-signup upload-error page for forms that say a PDF must be under 10MB. It routes users to the local PDF compressor with the 10MB target selected.", "No signup. Exact upload-error wording. Browser-based PDF compression path. 10MB target. Public-safe notes only. Free tool before any optional service request."],
  ...
  ["photo-120x160-20kb", "Photo 120x160 Under 20KB", "photo_120x160_20kb_2026_06", "photo_120x160_20kb_landing", "Free no-signup browser workflow for forms that need a 120 x 160 px photo under 20KB. It routes users through local portrait photo resizing and image-to-KB compression.", "No signup. Exact 120 x 160 px photo target. Strict 20KB size guidance. Browser resize and compression steps. Free tool path. Public-safe upload notes."],
  ["photo-160x200-30kb", "Photo 160x200 Under 30KB", "photo_160x200_30kb_2026_06", "photo_160x200_30kb_landing", "Free no-signup browser workflow for forms that need a 160 x 200 px photo under 30KB. It routes users through local portrait photo resizing and image-to-KB compression.", "No signup. Exact 160 x 200 px photo target. Strict 30KB size guidance. Browser resize and compression steps. Free tool path. Public-safe upload notes."],
  ["photo-300x400-100kb", "Photo 300x400 Under 100KB", "photo_300x400_100kb_2026_06", "photo_300x400_100kb_landing", "Free no-signup browser workflow for forms that need a 300 x 400 px photo under 100KB. It routes users through local portrait photo resizing and image-to-KB compression.", "No signup. Exact 300 x 400 px photo target. 100KB size guidance. Browser resize and compression steps. Free tool path. Public-safe upload notes."],
  ["photo-350x450-100kb", "Photo 350x450 Under 100KB", "photo_350x450_100kb_2026_06", "photo_350x450_100kb_landing", "Free no-signup browser workflow for forms that need a 350 x 450 px photo under 100KB. It routes users through local portrait photo resizing and image-to-KB compression.", "No signup. Exact 350 x 450 px photo target. 100KB size guidance. Browser resize and compression steps. Free tool path. Public-safe upload notes."],
  ["photo-360x480-100kb", "Photo 360x480 Under 100KB", "photo_360x480_100kb_2026_06", "photo_360x480_100kb_landing", "Free no-signup browser workflow for forms that need a 360 x 480 px photo under 100KB. It routes users through local portrait photo resizing and image-to-KB compression.", "No signup. Exact 360 x 480 px photo target. 100KB size guidance. Browser resize and compression steps. Free tool path. Public-safe upload notes."],
  ["photo-420x560-200kb", "Photo 420x560 Under 200KB", "photo_420x560_200kb_2026_06", "photo_420x560_200kb_landing", "Free no-signup browser workflow for forms that need a 420 x 560 px photo under 200KB. It routes users through local portrait photo resizing and image-to-KB compression.", "No signup. Exact 420 x 560 px photo target. 200KB size guidance. Browser resize and compression steps. Free tool path. Public-safe upload notes."],
