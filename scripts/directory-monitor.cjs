...
const nosignupExactUploadLimitListings = [
  ...
  ["Compress PDF to 100KB", "PDF 100KB compressor for very strict upload limits"],
  ["Compress PDF to 200KB", "PDF 200KB compressor for strict upload limits"],
  ["Compress PDF to 300KB", "PDF 300KB compressor for strict upload limits"],
  ...
  ["Compress PDF to 10MB", "PDF 10MB compressor for wider document upload limits"],
  ["PDF Size Reducer", "PDF size reducer hub for exact targets"],
  ["File Must Be Less Than 1MB Fix", "file under 1MB upload error fix"],
  ["PDF Must Be Under 100KB Fix", "PDF under 100KB upload error fix"],
  ["PDF Must Be Under 200KB Fix", "PDF under 200KB upload error fix"],
  ["PDF Must Be Under 300KB Fix", "PDF under 300KB upload error fix"],
  ["PDF Must Be Under 500KB Fix", "PDF under 500KB upload error fix"],
  ["PDF Must Be Under 10MB Fix", "PDF under 10MB upload error fix"],
  ...
  ["Photo 120x160 Under 20KB", "exact 120 x 160 px and 20KB photo path"],
  ["Photo 160x200 Under 30KB", "exact 160 x 200 px and 30KB photo path"],
  ["Photo 300x400 Under 100KB", "exact 300 x 400 px and 100KB photo path"],
  ["Photo 350x450 Under 100KB", "exact 350 x 450 px and 100KB photo path"],
  ["Photo 360x480 Under 100KB", "exact 360 x 480 px and 100KB photo path"],
  ["Photo 420x560 Under 200KB", "exact 420 x 560 px and 200KB photo path"],
...
const freenosignupUploadFixListings = [
  ["Compress PDF to 100KB", "PDF 100KB upload-limit path"],
  ["Compress PDF to 200KB", "PDF 200KB upload-limit path"],
  ["Compress PDF to 300KB", "PDF 300KB upload-limit path"],
  ["Compress PDF to 500KB", "PDF 500KB upload-limit path"],
  ["Compress PDF to 1MB", "PDF 1MB upload-limit path"],
  ["Compress PDF to 10MB", "PDF 10MB upload-limit path"],
  ["PDF Must Be Under 100KB Fix", "PDF under 100KB upload-error path"],
  ["PDF Must Be Under 200KB Fix", "PDF under 200KB upload-error path"],
  ["PDF Must Be Under 300KB Fix", "PDF under 300KB upload-error path"],
  ["PDF Must Be Under 10MB Fix", "PDF under 10MB upload-error path"],
...
const techtoolsExactUploadLimitListings = [
  ["Compress PDF to 100KB", "PDF 100KB target-size landing path", 255],
  ["Compress PDF to 200KB", "PDF 200KB target-size landing path", 256],
  ["Compress PDF to 300KB", "PDF 300KB target-size landing path", 257],
  ["Compress PDF to 10MB", "PDF 10MB target-size landing path", 258],
  ["PDF Must Be Under 100KB Fix", "PDF under 100KB upload-error path", 259],
  ["PDF Must Be Under 200KB Fix", "PDF under 200KB upload-error path", 260],
  ["PDF Must Be Under 300KB Fix", "PDF under 300KB upload-error path", 261],
  ["PDF Must Be Under 10MB Fix", "PDF under 10MB upload-error path", 262],
  ["Photo 120x160 Under 20KB", "exact 120 x 160 px and 20KB photo path", 263],
  ["Photo 160x200 Under 30KB", "exact 160 x 200 px and 30KB photo path", 264],
  ["Photo 300x400 Under 100KB", "exact 300 x 400 px and 100KB photo path", 265],
  ["Photo 350x450 Under 100KB", "exact 350 x 450 px and 100KB photo path", 266],
  ["Photo 360x480 Under 100KB", "exact 360 x 480 px and 100KB photo path", 267],
  ["Photo 420x560 Under 200KB", "exact 420 x 560 px and 200KB photo path", 268],
