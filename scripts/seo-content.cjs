...
const ZERO_DOMAIN_PLATFORM_STRATEGY = {
  ...
  parkedRoutes: [
    "GameDistribution remains a later distributor test after CrazyGames, Yandex, Playgama, and GamePix because dashboard gameId, legal consent, and manual submission are still required even though the SDK adapter is now present.",
