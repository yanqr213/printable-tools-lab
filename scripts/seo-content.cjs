...
const SHARE_KIT_FEATURED_LINKS = [
  ...
  ["PDF size reducer", "pdf-size-reducer", "Hub for exact PDF upload limits including 100KB, 200KB, 300KB, 500KB, 1MB, 2MB, 5MB, and 10MB."],
  ...
  ["Compress PDF to 100KB", "compress-pdf-to-100kb", "Strict exam, school, and tiny form upload limit intent."],
  ["Compress PDF to 200KB", "compress-pdf-to-200kb", "Severe small-PDF upload limit for scanned forms."],
  ["Compress PDF to 300KB", "compress-pdf-to-300kb", "Strict PDF upload limit with slightly more readable detail."],
  ...
  ["Compress PDF to 10MB", "compress-pdf-to-10mb", "Wider email, support, and portal PDF upload limit intent."],
...
const UPLOAD_LIMIT_SHORTCUTS = [
  ...
  ["PDF must be under 100KB", "/pdf-must-be-under-100kb/", "A tiny PDF upload cap usually used by exam, school, and strict admin forms.", "compress-pdf"],
  ["PDF must be under 200KB", "/pdf-must-be-under-200kb/", "A severe PDF upload error for short scanned forms and one-page documents.", "compress-pdf"],
  ["PDF must be under 300KB", "/pdf-must-be-under-300kb/", "A strict PDF upload error with slightly more room than 100KB or 200KB.", "compress-pdf"],
  ...
  ["PDF must be under 10MB", "/pdf-must-be-under-10mb/", "A wider upload cap for email, support, and document portals that still reject large scans.", "compress-pdf"],
  ...
  ["US passport photo 2x2", "/us-passport-photo-2x2/", "Prepare a US-style 2 x 2 inch passport photo locally before checking official rules.", "passport-photo"],
  ["US visa photo 600x600 under 240KB", "/us-visa-photo-600x600-240kb/", "Resize a square visa-style photo and compress toward a 240KB digital upload cap.", "resize-image"],
  ["UK digital passport photo", "/uk-passport-photo-digital/", "Prepare a UK-style digital passport photo locally before reviewing GOV.UK requirements.", "passport-photo"],
  ["Canada passport photo 50x70mm", "/canada-passport-photo-50x70mm/", "Crop a Canada-style 50 x 70 mm passport photo locally before final review.", "passport-photo"],
  ["Australia passport photo 35x45mm", "/australia-passport-photo-35x45mm/", "Prepare an Australia-style passport photo crop locally before checking official guidance.", "passport-photo"],
  ...
  ["Photo 295x413 under 35KB", "/photo-295x413-35kb/", "Prepare a 295 x 413 pixel portrait photo before compressing toward a strict 35KB cap.", "resize-image"],
  ...
  ["Photo 354x472 under 100KB", "/photo-354x472-100kb/", "Resize an ID-style 354 x 472 pixel photo before compressing toward a 100KB cap.", "resize-image"],
  ...
  ["Photo 480x640 under 200KB", "/photo-480x640-200kb/", "Prepare a 480 x 640 portrait photo and keep the export below a 200KB upload cap.", "resize-image"],
  ["Photo 512x512 under 100KB", "/photo-512x512-100kb/", "Resize square avatar or profile photos to 512 x 512 pixels under 100KB.", "resize-image"],
  ["Photo 150x200 under 20KB", "/photo-150x200-20kb/", "Prepare a compact 150 x 200 portrait photo and keep it below a strict 20KB cap.", "resize-image"],
  ["Photo 180x240 under 50KB", "/photo-180x240-50kb/", "Resize a 180 x 240 portrait photo before compressing toward a 50KB upload cap.", "resize-image"],
  ["Photo 400x514 under 100KB", "/photo-400x514-100kb/", "Prepare a 400 x 514 ID-style portrait photo under a 100KB cap.", "resize-image"],
  ["Photo 600x800 under 200KB", "/photo-600x800-200kb/", "Resize a larger 600 x 800 portrait photo before compressing toward 200KB.", "resize-image"],
  ["Photo 120x160 under 20KB", "/photo-120x160-20kb/", "Prepare a tiny 120 x 160 exam or application photo under a strict 20KB cap.", "resize-image"],
  ["Photo 160x200 under 30KB", "/photo-160x200-30kb/", "Resize a compact 160 x 200 portrait photo before compressing toward 30KB.", "resize-image"],
  ["Photo 300x400 under 100KB", "/photo-300x400-100kb/", "Prepare a 300 x 400 portrait application photo and keep it below 100KB.", "resize-image"],
  ["Photo 350x450 under 100KB", "/photo-350x450-100kb/", "Resize an ID-style 350 x 450 portrait photo before compressing toward 100KB.", "resize-image"],
  ["Photo 360x480 under 100KB", "/photo-360x480-100kb/", "Prepare a 360 x 480 portrait photo and keep the export below 100KB.", "resize-image"],
  ["Photo 420x560 under 200KB", "/photo-420x560-200kb/", "Resize a larger 420 x 560 portrait photo before compressing toward 200KB.", "resize-image"],
  ...
  ["Signature 160x70 under 20KB", "/signature-160x70-20kb/", "Match a compact 160 x 70 signature box and a strict 20KB upload cap.", "resize-image"],
  ...
  ["Signature 250x80 under 50KB", "/signature-250x80-50kb/", "Resize a 250 x 80 signature image before compressing toward a 50KB cap.", "resize-image"],
  ["Signature 300x60 under 20KB", "/signature-300x60-20kb/", "Prepare a long 300 x 60 signature strip and keep it below a strict 20KB cap.", "resize-image"],
  ...
  ["Signature 400x150 under 50KB", "/signature-400x150-50kb/", "Prepare a large 400 x 150 signature box and compress it toward 50KB.", "resize-image"],
  ["Signature 100x50 under 10KB", "/signature-100x50-10kb/", "Match a tiny 100 x 50 signature box and a strict 10KB upload cap.", "resize-image"],
  ["Signature 200x60 under 20KB", "/signature-200x60-20kb/", "Prepare a 200 x 60 signature strip and keep it below 20KB.", "resize-image"],
  ["Signature 256x64 under 20KB", "/signature-256x64-20kb/", "Resize a 256 x 64 signature image before compressing toward a strict 20KB cap.", "resize-image"],
  ["Signature 400x200 under 100KB", "/signature-400x200-100kb/", "Prepare a large 400 x 200 signature box under a 100KB upload cap.", "resize-image"],
...
const UPLOAD_LIMIT_DECISIONS = [
  ["PDF must be under 100KB", "/pdf-must-be-under-100kb/", "Fix PDF under 100KB", "Use the strictest PDF upload-error page when a tiny exam, school, or admin portal names a 100KB cap.", "compress-pdf"],
  ["PDF must be under 200KB", "/pdf-must-be-under-200kb/", "Fix PDF under 200KB", "Use the severe 200KB PDF upload-error page when the portal only allows a small scanned form.", "compress-pdf"],
  ["PDF must be under 300KB", "/pdf-must-be-under-300kb/", "Fix PDF under 300KB", "Use the 300KB PDF upload-error page when the destination allows a little more detail than 100KB or 200KB.", "compress-pdf"],
  ...
  ["PDF must be under 10MB", "/pdf-must-be-under-10mb/", "Fix PDF under 10MB", "Use the 10MB PDF upload-error page for email, support, and document portals with a wider cap.", "compress-pdf"],
  ...
  ["US passport photo must be 2 x 2 inches", "/us-passport-photo-2x2/", "Make US 2x2 photo", "Use the US passport-style crop helper, then compare the result with current official photo rules before submitting.", "passport-photo"],
  ["US visa photo must be 600 x 600 px and under 240KB", "/us-visa-photo-600x600-240kb/", "Make 600x600 visa photo", "Resize to 600 x 600 pixels first, then compress toward a 240KB custom target if the digital upload rejects the file.", "resize-image"],
  ["UK digital passport photo rejected", "/uk-passport-photo-digital/", "Prepare UK digital photo", "Use the UK passport-style crop helper, then review the downloaded file against the current digital-photo upload rules.", "passport-photo"],
  ["Canada passport photo must be 50 x 70 mm", "/canada-passport-photo-50x70mm/", "Make 50x70mm photo", "Use the Canada 50 x 70 mm crop helper, then compare the result with current official Canadian photo instructions.", "passport-photo"],
  ["Australia passport photo must be 35 x 45 mm", "/australia-passport-photo-35x45mm/", "Make 35x45mm photo", "Use the Australia-style 35 x 45 mm crop helper, then review the file against current official guidance.", "passport-photo"],
  ...
  ["Photo must be 295 x 413 px and under 35KB", "/photo-295x413-35kb/", "Make 295x413 photo", "Resize to 295 x 413 pixels first, then compress the portrait photo toward 35KB.", "resize-image"],
  ...
  ["Photo must be 354 x 472 px and under 100KB", "/photo-354x472-100kb/", "Make 354x472 photo", "Resize to 354 x 472 pixels first, then compress toward 100KB if the portal checks file size.", "resize-image"],
  ...
  ["Photo must be 480 x 640 px and under 200KB", "/photo-480x640-200kb/", "Make 480x640 photo", "Resize to 480 x 640 pixels first, then compress toward 200KB if needed.", "resize-image"],
  ["Photo must be 512 x 512 px and under 100KB", "/photo-512x512-100kb/", "Make 512x512 photo", "Crop or resize to 512 x 512 pixels first, then compress toward 100KB.", "resize-image"],
  ["Photo must be 150 x 200 px and under 20KB", "/photo-150x200-20kb/", "Make 150x200 photo", "Resize to 150 x 200 pixels first, then compress toward a strict 20KB cap.", "resize-image"],
  ["Photo must be 180 x 240 px and under 50KB", "/photo-180x240-50kb/", "Make 180x240 photo", "Resize to 180 x 240 pixels first, then compress toward 50KB if needed.", "resize-image"],
  ["Photo must be 400 x 514 px and under 100KB", "/photo-400x514-100kb/", "Make 400x514 photo", "Resize to 400 x 514 pixels first, then compress toward 100KB if the portal checks size.", "resize-image"],
  ["Photo must be 600 x 800 px and under 200KB", "/photo-600x800-200kb/", "Make 600x800 photo", "Resize to 600 x 800 pixels first, then compress toward 200KB if needed.", "resize-image"],
  ["Photo must be 120 x 160 px and under 20KB", "/photo-120x160-20kb/", "Make 120x160 photo", "Resize to 120 x 160 pixels first, then compress toward a strict 20KB cap.", "resize-image"],
  ["Photo must be 160 x 200 px and under 30KB", "/photo-160x200-30kb/", "Make 160x200 photo", "Resize to 160 x 200 pixels first, then compress toward 30KB if needed.", "resize-image"],
  ["Photo must be 300 x 400 px and under 100KB", "/photo-300x400-100kb/", "Make 300x400 photo", "Resize to 300 x 400 pixels first, then compress toward 100KB if the portal checks size.", "resize-image"],
  ["Photo must be 350 x 450 px and under 100KB", "/photo-350x450-100kb/", "Make 350x450 photo", "Resize to 350 x 450 pixels first, then compress toward 100KB if needed.", "resize-image"],
  ["Photo must be 360 x 480 px and under 100KB", "/photo-360x480-100kb/", "Make 360x480 photo", "Resize to 360 x 480 pixels first, then compress toward 100KB after export.", "resize-image"],
  ["Photo must be 420 x 560 px and under 200KB", "/photo-420x560-200kb/", "Make 420x560 photo", "Resize to 420 x 560 pixels first, then compress toward 200KB if needed.", "resize-image"],
  ...
  ["Signature must be 160 x 70 px and under 20KB", "/signature-160x70-20kb/", "Make 160x70 signature", "Resize the signature to 160 x 70 pixels, then compress the exported strip toward 20KB.", "resize-image"],
  ...
  ["Signature must be 250 x 80 px and under 50KB", "/signature-250x80-50kb/", "Make 250x80 signature", "Resize to 250 x 80 pixels first, then compress toward 50KB if the portal checks file size.", "resize-image"],
  ["Signature must be 300 x 60 px and under 20KB", "/signature-300x60-20kb/", "Make 300x60 signature", "Resize to 300 x 60 pixels first, then compress toward a strict 20KB cap.", "resize-image"],
  ...
  ["Signature must be 400 x 150 px and under 50KB", "/signature-400x150-50kb/", "Make 400x150 signature", "Resize to 400 x 150 pixels first, then compress toward 50KB for larger signature boxes.", "resize-image"],
  ["Signature must be 100 x 50 px and under 10KB", "/signature-100x50-10kb/", "Make 100x50 signature", "Resize to 100 x 50 pixels first, then compress toward a strict 10KB cap.", "resize-image"],
  ["Signature must be 200 x 60 px and under 20KB", "/signature-200x60-20kb/", "Make 200x60 signature", "Resize to 200 x 60 pixels first, then compress toward 20KB if needed.", "resize-image"],
  ["Signature must be 256 x 64 px and under 20KB", "/signature-256x64-20kb/", "Make 256x64 signature", "Resize to 256 x 64 pixels first, then compress toward a strict 20KB cap.", "resize-image"],
  ["Signature must be 400 x 200 px and under 100KB", "/signature-400x200-100kb/", "Make 400x200 signature", "Resize to 400 x 200 pixels first, then compress toward 100KB if needed.", "resize-image"],
...
const UPLOAD_ERROR_CHEATSHEET = [
  ...
  },
  {
    ...
    landingPath: "pdf-must-be-under-100kb",
    toolPath: "tools/compress-pdf?targetSize=100kb",
  ...
  },
  {
    ...
    landingPath: "pdf-must-be-under-200kb",
    toolPath: "tools/compress-pdf?targetSize=200kb",
  ...
  },
  {
    ...
    landingPath: "pdf-must-be-under-300kb",
    toolPath: "tools/compress-pdf?targetSize=300kb",
  ...
  },
  {
    ...
    landingPath: "pdf-must-be-under-10mb",
    toolPath: "tools/compress-pdf?targetSize=10mb",
  ...
  },
  {
    ...
    landingPath: "us-passport-photo-2x2",
    toolPath: "tools/passport-photo?preset=us-passport",
  ...
  },
  {
    ...
    landingPath: "us-visa-photo-600x600-240kb",
  ...
  },
  {
    ...
    landingPath: "uk-passport-photo-digital",
    toolPath: "tools/passport-photo?preset=uk-passport",
  ...
  },
  {
    ...
    landingPath: "canada-passport-photo-50x70mm",
    toolPath: "tools/passport-photo?preset=canada-passport",
  ...
  },
  {
    ...
    landingPath: "australia-passport-photo-35x45mm",
    toolPath: "tools/passport-photo?preset=australia-passport",
  ...
  },
  {
    ...
    landingPath: "photo-200x230-20kb",
    toolPath: "tools/resize-image?width=200&height=230&fit=cover",
  ...
  },
  {
    ...
    landingPath: "photo-200x230-50kb",
    toolPath: "tools/resize-image?width=200&height=230&fit=cover",
  ...
  },
  {
    ...
    landingPath: "photo-200x230-100kb",
    toolPath: "tools/resize-image?width=200&height=230&fit=cover",
  ...
  },
  {
    ...
    landingPath: "photo-240x320-50kb",
    toolPath: "tools/resize-image?width=240&height=320&fit=cover",
  ...
  },
  {
    ...
    landingPath: "photo-295x413-35kb",
    toolPath: "tools/resize-image?width=295&height=413&fit=cover",
  ...
  },
  {
    ...
    landingPath: "photo-413x531-100kb",
    toolPath: "tools/resize-image?width=413&height=531&fit=cover",
  ...
  },
  {
    ...
    landingPath: "photo-413x531-50kb",
    toolPath: "tools/resize-image?width=413&height=531&fit=cover",
  ...
  },
  {
    ...
    landingPath: "photo-354x472-100kb",
    toolPath: "tools/resize-image?width=354&height=472&fit=cover",
  ...
  },
  {
    ...
    landingPath: "photo-300x300-100kb",
    toolPath: "tools/resize-image?width=300&height=300&fit=cover",
  ...
  },
  {
    ...
    landingPath: "photo-600x600-100kb",
    toolPath: "tools/resize-image?width=600&height=600&fit=cover",
  ...
  },
  {
    ...
    landingPath: "photo-480x640-200kb",
    toolPath: "tools/resize-image?width=480&height=640&fit=cover",
  ...
  },
  {
    ...
    landingPath: "photo-512x512-100kb",
    toolPath: "tools/resize-image?width=512&height=512&fit=cover",
  ...
  },
  {
    ...
    landingPath: "photo-150x200-20kb",
    toolPath: "tools/resize-image?width=150&height=200&fit=cover",
  ...
  },
  {
    ...
    landingPath: "photo-180x240-50kb",
    toolPath: "tools/resize-image?width=180&height=240&fit=cover",
  ...
  },
  {
    ...
    landingPath: "photo-400x514-100kb",
    toolPath: "tools/resize-image?width=400&height=514&fit=cover",
  ...
  },
  {
    ...
    landingPath: "photo-600x800-200kb",
    toolPath: "tools/resize-image?width=600&height=800&fit=cover",
  ...
  },
  {
    ...
    landingPath: "photo-120x160-20kb",
    toolPath: "tools/resize-image?width=120&height=160&fit=cover",
  ...
  },
  {
    ...
    landingPath: "photo-160x200-30kb",
    toolPath: "tools/resize-image?width=160&height=200&fit=cover",
  ...
  },
  {
    ...
    landingPath: "photo-300x400-100kb",
    toolPath: "tools/resize-image?width=300&height=400&fit=cover",
  ...
  },
  {
    ...
    landingPath: "photo-350x450-100kb",
    toolPath: "tools/resize-image?width=350&height=450&fit=cover",
  ...
  },
  {
    ...
    landingPath: "photo-360x480-100kb",
    toolPath: "tools/resize-image?width=360&height=480&fit=cover",
  ...
  },
  {
    ...
    landingPath: "photo-420x560-200kb",
    toolPath: "tools/resize-image?width=420&height=560&fit=cover",
  ...
  },
  {
    ...
    landingPath: "signature-140x60-20kb",
    toolPath: "tools/resize-image?width=140&height=60&fit=contain",
  ...
  },
  {
    ...
    landingPath: "signature-140x60-50kb",
    toolPath: "tools/resize-image?width=140&height=60&fit=contain",
  ...
  },
  {
    ...
    landingPath: "signature-150x50-20kb",
    toolPath: "tools/resize-image?width=150&height=50&fit=contain",
  ...
  },
  {
    ...
    landingPath: "signature-160x70-20kb",
    toolPath: "tools/resize-image?width=160&height=70&fit=contain",
  ...
  },
  {
    ...
    landingPath: "signature-200x50-20kb",
    toolPath: "tools/resize-image?width=200&height=50&fit=contain",
  ...
  },
  {
    ...
    landingPath: "signature-200x100-50kb",
    toolPath: "tools/resize-image?width=200&height=100&fit=contain",
  ...
  },
  {
    ...
    landingPath: "signature-250x80-50kb",
    toolPath: "tools/resize-image?width=250&height=80&fit=contain",
  ...
  },
  {
    ...
    landingPath: "signature-300x60-20kb",
    toolPath: "tools/resize-image?width=300&height=60&fit=contain",
  ...
  },
  {
    ...
    landingPath: "signature-300x80-50kb",
    toolPath: "tools/resize-image?width=300&height=80&fit=contain",
  ...
  },
  {
    ...
    landingPath: "signature-300x100-50kb",
    toolPath: "tools/resize-image?width=300&height=100&fit=contain",
  ...
  },
  {
    ...
    landingPath: "signature-400x150-50kb",
    toolPath: "tools/resize-image?width=400&height=150&fit=contain",
  ...
  },
  {
    ...
    landingPath: "signature-100x50-10kb",
    toolPath: "tools/resize-image?width=100&height=50&fit=contain",
  ...
  },
  {
    ...
    landingPath: "signature-200x60-20kb",
    toolPath: "tools/resize-image?width=200&height=60&fit=contain",
  ...
  },
  {
    ...
    landingPath: "signature-256x64-20kb",
    toolPath: "tools/resize-image?width=256&height=64&fit=contain",
  ...
  },
  {
    ...
    landingPath: "signature-400x200-100kb",
    toolPath: "tools/resize-image?width=400&height=200&fit=contain",
...
function exactPhotoUploadLandingPage({ path, width, height, kb, title, description, headline, lead, intent, sections }) {
  return {
    path,
    title,
    description,
    headline,
    lead,
    primaryTool: `tools/resize-image?width=${width}&height=${height}&fit=cover`,
    intent,
    sections,
    serviceLead: uploadLimitLandingServiceLead(`make a ${width} x ${height} px photo under ${kb}KB`),
    relatedTools: [
      `tools/resize-image?width=${width}&height=${height}&fit=cover`,
      `tools/compress-image-to-kb?targetKb=${kb}`,
      "tools/passport-photo",
      "tools/crop-image",
    ],
  };
...
function exactSignatureUploadLandingPage({ path, width, height, kb, title, description, headline, lead, intent, sections }) {
  return {
    path,
    title,
    description,
    headline,
    lead,
    primaryTool: `tools/resize-image?width=${width}&height=${height}&fit=contain`,
    intent,
    sections,
    serviceLead: uploadLimitLandingServiceLead(`make a ${width} x ${height} px signature under ${kb}KB`),
    relatedTools: [
      `tools/resize-image?width=${width}&height=${height}&fit=contain`,
      `tools/compress-image-to-kb?targetKb=${kb}`,
      "tools/signature-png",
      kb <= 20 ? "tools/remove-background" : "tools/crop-image",
    ],
  };
}

function passportSpecLandingPage({ path, title, description, headline, lead, preset, intent, sections, primaryTool, relatedTools = [] }) {
  return {
    path,
    title,
    description,
    headline,
    lead,
    primaryTool: primaryTool || `tools/passport-photo?preset=${preset}`,
    intent,
    sections,
    serviceLead: uploadLimitLandingServiceLead(`prepare a passport-style photo for ${headline.toLowerCase()}`),
    relatedTools: [
      `tools/passport-photo?preset=${preset}`,
      ...relatedTools,
      "tools/compress-image-to-kb",
      "tools/resize-image",
      "tools/crop-image",
...
const PASSPORT_SPEC_LANDING_PAGES = [
  passportSpecLandingPage({
    path: "us-passport-photo-2x2",
    title: "US Passport Photo 2x2 Maker",
    description: "Crop and export a US-style 2 x 2 inch passport photo locally, then compare it with the current official photo rules before submitting.",
    headline: "Make a US passport-style 2 x 2 photo",
    lead: "Use this when you need a 2 x 2 inch passport-style photo and want a local crop/export workflow before checking the official submission rules.",
    preset: "us-passport",
    intent: "US passport photo 2x2, 2 x 2 inch passport photo maker, passport photo crop no upload",
    sections: [
      ["Start with the 2 x 2 inch preset", "The photo tool opens with the US 2 x 2 inch preset, 300 DPI export, and a face guide so you can crop before making a single JPG, PNG, or 4 x 6 print sheet."],
      ["Keep this as a preparation tool", "Official photo acceptance depends on more than size: age of photo, face position, background, lighting, glasses, shadows, expression, and the exact destination workflow still matter."],
      ["Review before submission", "Download the file, open it locally, and compare the result with the current official page before uploading, printing, or taking it to a photo service."],
    ],
  }),
  passportSpecLandingPage({
    path: "us-visa-photo-600x600-240kb",
    title: "US Visa Photo 600x600 Under 240KB",
    description: "Prepare a square 600 x 600 visa-style photo and compress it toward a 240KB upload limit with local browser tools.",
    headline: "Make a 600 x 600 visa-style photo under 240KB",
    lead: "Use this when a visa, DS-160, or diversity-style upload asks for a square digital photo and a file-size cap. Resize first, then compress only if needed.",
    preset: "us-passport",
    primaryTool: "tools/resize-image?width=600&height=600&fit=cover",
    intent: "US visa photo 600x600 240KB, DV lottery photo 600 x 600, visa photo under 240KB",
    sections: [
      ["Create the square image first", "Open the 600 x 600 resizer from this page when the destination names pixel dimensions. Use the passport photo cropper first if you need a face guide before resizing."],
      ["Compress toward 240KB", "After the image is square, use the image-to-KB compressor with a custom 240KB target. Review the downloaded image for softness before submitting it."],
      ["Check the current official rule", "Digital visa-photo rules can include format, color, head size, recency, background, and file-size details. This page prepares a file; it does not certify official acceptance."],
    ],
    relatedTools: ["tools/resize-image?width=600&height=600&fit=cover", "tools/compress-image-to-kb?targetKb=240"],
  }),
  passportSpecLandingPage({
    path: "uk-passport-photo-digital",
    title: "UK Digital Passport Photo Helper",
    description: "Prepare a UK-style digital passport photo locally with a 35 x 45 mm crop helper, then review current GOV.UK digital upload rules.",
    headline: "Prepare a UK digital passport-style photo",
    lead: "Use this when you need a UK-style passport photo workflow and want to crop locally before comparing the output with the current digital-photo requirements.",
    preset: "uk-passport",
    intent: "UK digital passport photo, UK passport photo 35x45, passport photo 600x750 pixels",
    sections: [
      ["Use the UK 35 x 45 mm preset", "The passport photo maker includes a UK-style 35 x 45 mm preset and can export a single JPG or PNG without uploading the original photo."],
      ["Mind digital upload limits", "UK digital-photo workflows can check pixel size, file size, background, face placement, and recency. Use this page for local preparation, then follow GOV.UK for the final rule."],
      ["Export and inspect", "Open the downloaded file, check face placement and background, and keep the original nearby in case the upload service asks for a different crop or file size."],
    ],
  }),
  passportSpecLandingPage({
    path: "canada-passport-photo-50x70mm",
    title: "Canada Passport Photo 50x70mm Maker",
    description: "Crop and export a Canada-style 50 x 70 mm passport photo locally before checking the current official Canadian photo requirements.",
    headline: "Make a Canada passport-style 50 x 70 mm photo",
    lead: "Use this when you need a 50 x 70 mm Canada-style passport photo crop and want to prepare a local file or print-sheet before final review.",
    preset: "canada-passport",
    intent: "Canada passport photo 50x70mm, Canadian passport photo size, 50 x 70 mm photo maker",
    sections: [
      ["Start with 50 x 70 mm", "The passport photo tool opens with the Canada 50 x 70 mm preset so you can align the head guide and export a single image or 4 x 6 print sheet."],
      ["Do not skip official checks", "Canadian passport-photo rules include size, recency, studio/printing expectations, background, face visibility, and other details beyond this file-prep helper."],
      ["Keep a review copy", "Download the prepared image, inspect it locally, and compare it with the current official Canadian instructions before printing or submitting."],
    ],
  }),
  passportSpecLandingPage({
    path: "australia-passport-photo-35x45mm",
    title: "Australia Passport Photo 35x45mm Helper",
    description: "Prepare an Australia-style 35 x 45 mm passport photo locally, then compare it with current Australian passport photo guidelines.",
    headline: "Prepare an Australia passport-style 35 x 45 mm photo",
    lead: "Use this when you need an Australia-style passport photo crop and want a local no-upload preparation path before checking official photo guidance.",
    preset: "australia-passport",
    intent: "Australia passport photo 35x45mm, Australian passport photo size, passport photo crop no upload",
    sections: [
      ["Use the Australia preset", "The passport photo maker includes an Australia 35 x 45 mm preset and a face guide so you can crop and export locally."],
      ["Allow for official size ranges", "Australian passport guidance can refer to photo and face-size ranges, plus background, glasses, expression, and print quality. Treat this page as a preparation helper."],
      ["Review the final file", "Open the downloaded image or print sheet and compare it with the current Australian passport-photo instructions before using it for an application."],
    ],
  }),
];
...
const NEXT_EXACT_PHOTO_UPLOAD_PAGE_SPECS = [
  {
    ...
    height: 160,
    kb: 20,
    title: "Photo 120x160 Pixels Under 20KB",
    description: "Resize a tiny exam or application photo to 120 x 160 pixels locally and compress it toward a strict 20KB cap.",
    headline: "Make a 120 x 160 px photo under 20KB",
    lead: "Use this when a portal names a small 120 x 160 pixel portrait photo and rejects files above 20KB.",
    intent: "photo 120x160 20KB, resize photo 120 x 160 under 20KB, exam photo upload",
    sections: [
      ["Resize before compression", "Open the resizer with 120 x 160 pixels prefilled. At this size, face placement matters more than chasing file size first."],
      ["Use the 20KB target only after export", "A 20KB cap is strict, but a 120 x 160 photo can usually fit if the crop is clean and the background is simple."],
      ["Check the destination rule", "Compare pixel size, KB size, crop, background, and format before submitting. This helper does not guarantee acceptance by any portal."],
    ],
  },
  {
    path: "photo-160x200-30kb",
    width: 160,
    height: 200,
    kb: 30,
    title: "Photo 160x200 Pixels Under 30KB",
    description: "Resize a compact portrait photo to 160 x 200 pixels locally and compress it toward a 30KB upload cap.",
    headline: "Make a 160 x 200 px photo under 30KB",
    lead: "Use this when an exam, school, profile, or application form asks for a 160 x 200 pixel photo below 30KB.",
    intent: "photo 160x200 30KB, resize photo 160 x 200 under 30KB, application photo upload",
    sections: [
      ["Match 160 x 200 first", "Use the prefilled resizer before reducing quality. A photo that is under 30KB can still fail if the dimensions are wrong."],
      ["Compress the resized copy", "After export, use the 30KB target only if the receiving site still rejects the file size."],
      ["Review clarity", "Open the final file and check the face, text, background, and edges before uploading it elsewhere."],
    ],
  },
  {
    path: "photo-300x400-100kb",
    width: 300,
    height: 400,
    kb: 100,
    title: "Photo 300x400 Pixels Under 100KB",
    description: "Resize a portrait application photo to 300 x 400 pixels locally and compress it toward a 100KB upload cap.",
    headline: "Make a 300 x 400 px photo under 100KB",
    lead: "Use this when a profile, school, ID-style, or admin portal needs a 300 x 400 pixel portrait photo and a file below 100KB.",
    intent: "photo 300x400 100KB, resize photo 300 x 400 under 100KB, portrait application photo",
    sections: [
      ["Create the portrait first", "Use the 300 x 400 preset before compressing. Pixel validation usually happens before file-size validation."],
      ["Keep detail at 100KB", "A 100KB cap normally preserves enough detail for a 300 x 400 photo. Compress only if the resized output is still too large."],
      ["Avoid official-photo claims", "This page prepares dimensions and file size locally. It does not validate identity, lighting, background, pose, or official acceptance."],
    ],
  },
  {
    path: "photo-350x450-100kb",
    width: 350,
    height: 450,
    kb: 100,
    title: "Photo 350x450 Pixels Under 100KB",
    description: "Resize an ID-style portrait photo to 350 x 450 pixels locally and compress it toward a 100KB upload cap.",
    headline: "Make a 350 x 450 px photo under 100KB",
    lead: "Use this when an upload box asks for a 350 x 450 pixel portrait photo and rejects files above 100KB.",
    intent: "photo 350x450 100KB, resize photo 350 x 450 under 100KB, ID photo upload",
    sections: [
      ["Use the exact portrait preset", "The linked resizer opens with 350 x 450 pixels ready, which helps when a form checks dimensions before file size."],
      ["Compress after resizing", "After export, use the 100KB image target only if the resized file remains too large for the destination form."],
      ["Check visible details", "Review face placement, background, file size, and dimensions before submitting the image to a third-party site."],
    ],
  },
  {
    path: "photo-360x480-100kb",
    width: 360,
    height: 480,
    kb: 100,
    title: "Photo 360x480 Pixels Under 100KB",
    description: "Resize a portrait photo to 360 x 480 pixels locally and compress it toward a 100KB upload cap.",
    headline: "Make a 360 x 480 px photo under 100KB",
    lead: "Use this when a form names a 360 x 480 pixel portrait size and also requires the image to stay below 100KB.",
    intent: "photo 360x480 100KB, resize photo 360 x 480 under 100KB, portrait photo upload",
    sections: [
      ["Resize to 360 x 480 first", "Open the resizer with the exact pixels prefilled. Cover mode fills the portrait frame, so check face placement."],
      ["Then target 100KB", "A 100KB cap is usually reachable after resizing, but review compression softness around eyes, hair, and text."],
      ["Keep the original", "Save the original photo in case the final upload needs a clearer crop, different background, or a different format."],
    ],
  },
  {
    path: "photo-420x560-200kb",
    width: 420,
    height: 560,
    kb: 200,
    title: "Photo 420x560 Pixels Under 200KB",
    description: "Resize a larger portrait photo to 420 x 560 pixels locally and compress it toward a 200KB upload cap.",
    headline: "Make a 420 x 560 px photo under 200KB",
    lead: "Use this when an application, profile, ID-style, or admin portal wants a 420 x 560 pixel portrait photo under 200KB.",
    intent: "photo 420x560 200KB, resize photo 420 x 560 under 200KB, portrait application upload",
    sections: [
      ["Prepare the larger portrait", "Create the 420 x 560 image before compressing. A file-size pass does not help if the width and height are rejected."],
      ["Use 200KB if needed", "After resizing, compress toward 200KB only if the exported file is still too large. This target usually keeps more visible detail."],
      ["Review before upload", "Check dimensions, file size, crop, and format against the current destination notice before submitting."],
    ],
  },
];

const ADDITIONAL_EXACT_PHOTO_UPLOAD_PAGES = [
  exactPhotoUploadLandingPage({
    path: "photo-295x413-35kb",
    width: 295,
    height: 413,
    kb: 35,
    title: "Photo 295x413 Pixels Under 35KB",
    description: "Resize a portrait photo to 295 x 413 pixels locally and compress it toward a strict 35KB upload cap.",
    headline: "Make a 295 x 413 px photo under 35KB",
    lead: "Use this when a form asks for an exact 295 x 413 pixel photo and rejects files above 35KB. Resize first so the dimensions pass before you chase the file-size target.",
    intent: "photo 295x413 35KB, resize photo 295 x 413 under 35KB, application photo upload",
    sections: [
      ["Match the 295 x 413 box", "Open the resizer with 295 x 413 pixels prefilled. Cover mode fills the portrait frame, so crop or adjust face placement first if the destination is strict."],
      ["Then target 35KB", "A 35KB cap is tight for a portrait photo. Compress only after the dimensions are correct, and expect some softness in fine details."],
      ["Review before upload", "Check the final file against the current portal notice for pixel size, file size, face placement, and background. This helper does not guarantee acceptance by any portal."],
    ],
  }),
  exactPhotoUploadLandingPage({
    path: "photo-354x472-100kb",
    width: 354,
    height: 472,
    kb: 100,
    title: "Photo 354x472 Pixels Under 100KB",
    description: "Resize an ID-style photo to 354 x 472 pixels locally and compress it toward a 100KB upload cap.",
    headline: "Make a 354 x 472 px photo under 100KB",
    lead: "Use this when an upload form names the exact 354 x 472 pixel photo size and a 100KB file limit. Start with the prefilled resizer, then compress only if needed.",
    intent: "photo 354x472 100KB, resize photo 354 x 472 under 100KB, ID photo upload",
    sections: [
      ["Resize to exact pixels", "The linked resizer opens with 354 x 472 pixels ready. This helps when a form checks width and height before it checks file size."],
      ["Keep more detail at 100KB", "A 100KB cap usually preserves more detail than tiny 20KB or 35KB targets. Compress the resized output only if the receiving site still rejects it."],
      ["Check the current rule", "Compare the downloaded image with the destination notice for crop, background, dimensions, and KB size. This local helper cannot verify official photo rules."],
    ],
  }),
  exactPhotoUploadLandingPage({
    path: "photo-480x640-200kb",
    width: 480,
    height: 640,
    kb: 200,
    title: "Photo 480x640 Pixels Under 200KB",
    description: "Resize a portrait photo to 480 x 640 pixels locally and compress it toward a 200KB upload cap.",
    headline: "Make a 480 x 640 px photo under 200KB",
    lead: "Use this when a profile, application, or ID-style upload box asks for a 480 x 640 pixel portrait photo and rejects files above 200KB.",
    intent: "photo 480x640 200KB, resize photo 480 x 640 under 200KB, portrait photo upload",
    sections: [
      ["Create the portrait first", "Use the 480 x 640 preset before compressing. A photo can be under 200KB and still fail if its dimensions are wrong."],
      ["Compress after export", "After resizing, use the 200KB image target only if the resulting file is still too large. Review hair, face, edges, and background after compression."],
      ["Avoid portal assumptions", "This page prepares pixels and file size locally. It does not check official acceptance, identity, recency, background, or pose requirements."],
    ],
  }),
  exactPhotoUploadLandingPage({
    path: "photo-512x512-100kb",
    width: 512,
    height: 512,
    kb: 100,
    title: "Photo 512x512 Pixels Under 100KB",
    description: "Resize a square avatar, profile, or application photo to 512 x 512 pixels locally and compress it toward a 100KB cap.",
    headline: "Make a 512 x 512 px photo under 100KB",
    lead: "Use this when a profile, school, marketplace, or application form requires a 512 x 512 pixel square photo and also enforces a 100KB file-size limit.",
    intent: "photo 512x512 100KB, resize square photo 512 x 512 under 100KB, avatar upload",
    sections: [
      ["Crop to a square", "Open the resizer with 512 x 512 pixels prefilled. Cover mode fills the square, so check whether the face or subject stays centered."],
      ["Then compress toward 100KB", "A 512 x 512 photo may need compression after resizing. Use the 100KB target and review the downloaded file before submitting it."],
      ["Use for ordinary upload boxes", "This helper is for common profile and application uploads. It does not validate official ID, visa, or portal-specific image rules."],
    ],
  }),
  exactPhotoUploadLandingPage({
    path: "photo-150x200-20kb",
    width: 150,
    height: 200,
    kb: 20,
    title: "Photo 150x200 Pixels Under 20KB",
    description: "Resize a small application or exam photo to 150 x 200 pixels locally and compress it toward a strict 20KB cap.",
    headline: "Make a 150 x 200 px photo under 20KB",
    lead: "Use this when an upload form asks for a compact 150 x 200 pixel portrait photo and rejects files above 20KB.",
    intent: "photo 150x200 20KB, resize photo 150 x 200 under 20KB, exam photo upload",
    sections: [
      ["Create the small portrait first", "Open the resizer with 150 x 200 pixels prefilled. Cover mode fills the portrait box, so check face placement before exporting."],
      ["Then use a strict 20KB target", "At this small size a 20KB cap is usually reachable, but compression can soften edges. Compress only after the dimensions match."],
      ["Check before uploading", "Compare the downloaded file with the destination notice for dimensions, KB size, crop, and background. This helper does not guarantee acceptance by any portal."],
    ],
  }),
  exactPhotoUploadLandingPage({
    path: "photo-180x240-50kb",
    width: 180,
    height: 240,
    kb: 50,
    title: "Photo 180x240 Pixels Under 50KB",
    description: "Resize a portrait photo to 180 x 240 pixels locally and compress it toward a 50KB upload cap.",
    headline: "Make a 180 x 240 px photo under 50KB",
    lead: "Use this when an exam, profile, school, or admin upload asks for a 180 x 240 pixel photo below 50KB.",
    intent: "photo 180x240 50KB, resize photo 180 x 240 under 50KB, portrait upload",
    sections: [
      ["Match 180 x 240 first", "Use the prefilled resizer before compressing. A photo that is under 50KB can still fail if the width and height are wrong."],
      ["Compress after resizing", "Run the resized copy through image-to-KB only if the exported file still exceeds 50KB. Keep the original image as a fallback."],
      ["Review the visible details", "Open the final file and check face placement, text, edges, and background before uploading it elsewhere."],
    ],
  }),
  exactPhotoUploadLandingPage({
    path: "photo-400x514-100kb",
    width: 400,
    height: 514,
    kb: 100,
    title: "Photo 400x514 Pixels Under 100KB",
    description: "Resize an ID-style portrait photo to 400 x 514 pixels locally and compress it toward a 100KB upload cap.",
    headline: "Make a 400 x 514 px photo under 100KB",
    lead: "Use this when a portal names a 400 x 514 pixel portrait photo size and a 100KB file-size limit.",
    intent: "photo 400x514 100KB, resize photo 400 x 514 under 100KB, ID photo upload",
    sections: [
      ["Use the exact portrait preset", "The linked resizer opens with 400 x 514 pixels ready, which helps when a form checks image dimensions before file size."],
      ["Keep detail at 100KB", "A 100KB cap usually leaves enough detail for a portrait photo. Compress the resized output only if the receiving site still rejects it."],
      ["Avoid official-photo claims", "This page prepares pixels and KB size locally. It does not validate background, pose, identity, recency, or official document rules."],
    ],
  }),
  exactPhotoUploadLandingPage({
    path: "photo-600x800-200kb",
    width: 600,
    height: 800,
    kb: 200,
    title: "Photo 600x800 Pixels Under 200KB",
    description: "Resize a larger portrait photo to 600 x 800 pixels locally and compress it toward a 200KB upload cap.",
    headline: "Make a 600 x 800 px photo under 200KB",
    lead: "Use this when an application, ID-style, or admin portal wants a 600 x 800 pixel portrait photo under 200KB.",
    intent: "photo 600x800 200KB, resize photo 600 x 800 under 200KB, portrait application upload",
    sections: [
      ["Resize before reducing quality", "Create the 600 x 800 portrait first. The file-size check is not useful until the width and height match the destination rule."],
      ["Use the 200KB target if needed", "After resizing, compress toward 200KB only if the export is still too large. Review skin, hair, background, and text after compression."],
      ["Keep the destination rule nearby", "Check dimensions, file size, format, and crop against the current upload notice before submitting the file."],
    ],
  }),
  ...NEXT_EXACT_PHOTO_UPLOAD_PAGE_SPECS.map(exactPhotoUploadLandingPage),
];

const ADDITIONAL_EXACT_SIGNATURE_UPLOAD_PAGES = [
  exactSignatureUploadLandingPage({
    path: "signature-160x70-20kb",
    width: 160,
    height: 70,
    kb: 20,
    title: "Signature 160x70 Pixels Under 20KB",
    description: "Resize a signature image to 160 x 70 pixels locally and compress it toward a strict 20KB upload cap.",
    headline: "Make a 160 x 70 px signature under 20KB",
    lead: "Use this when a form requires a compact 160 x 70 pixel signature image and rejects files above 20KB.",
    intent: "signature 160x70 20KB, resize signature 160 x 70 under 20KB, signature upload",
    sections: [
      ["Use the compact signature box", "Open the resizer with 160 x 70 pixels prefilled. Fit-inside mode keeps strokes visible and pads the box instead of cropping the signature."],
      ["Compress after resizing", "After the dimensions match, use the 20KB image target if the portal still rejects the file size. Keep the original scan in case the result becomes too faint."],
      ["Review the signature", "Check for broken, clipped, or pale strokes before uploading. This is a visual file helper, not identity verification or an e-signature service."],
    ],
  }),
  exactSignatureUploadLandingPage({
    path: "signature-250x80-50kb",
    width: 250,
    height: 80,
    kb: 50,
    title: "Signature 250x80 Pixels Under 50KB",
    description: "Resize a signature image to 250 x 80 pixels locally and compress it toward a 50KB upload cap.",
    headline: "Make a 250 x 80 px signature under 50KB",
    lead: "Use this when a signature upload box asks for exactly 250 x 80 pixels and a file below 50KB.",
    intent: "signature 250x80 50KB, resize signature 250 x 80 under 50KB, signature image upload",
    sections: [
      ["Match the 250 x 80 box", "Open the resizer with 250 x 80 pixels ready. Fit-inside mode helps preserve the full signature while meeting the required canvas size."],
      ["Use 50KB after sizing", "A file can pass the KB limit and still fail if the dimensions are wrong. Resize first, then compress toward 50KB if needed."],
      ["Check readability", "Review the exported signature for clipping, blur, and weak contrast before uploading it anywhere important."],
    ],
  }),
  exactSignatureUploadLandingPage({
    path: "signature-300x60-20kb",
    width: 300,
    height: 60,
    kb: 20,
    title: "Signature 300x60 Pixels Under 20KB",
    description: "Resize a long signature image to 300 x 60 pixels locally and compress it toward a strict 20KB upload cap.",
    headline: "Make a 300 x 60 px signature under 20KB",
    lead: "Use this when a portal needs a long 300 x 60 pixel signature strip and a tiny 20KB file-size limit.",
    intent: "signature 300x60 20KB, resize signature 300 x 60 under 20KB, signature upload",
    sections: [
      ["Use the long strip preset", "Open the resizer with 300 x 60 pixels prefilled. Fit-inside mode helps keep the whole signature visible inside the narrow box."],
      ["Then target 20KB", "A 20KB cap can make strokes faint. Compress the resized copy only as much as needed and keep the original scan available."],
      ["Review before submit", "Check that the signature remains centered, dark, and complete. This creates a visual upload file only and does not verify consent or identity."],
    ],
  }),
  exactSignatureUploadLandingPage({
    path: "signature-400x150-50kb",
    width: 400,
    height: 150,
    kb: 50,
    title: "Signature 400x150 Pixels Under 50KB",
    description: "Resize a larger signature image to 400 x 150 pixels locally and compress it toward a 50KB upload cap.",
    headline: "Make a 400 x 150 px signature under 50KB",
    lead: "Use this when a form gives a larger 400 x 150 pixel signature box and rejects exported files above 50KB.",
    intent: "signature 400x150 50KB, resize signature 400 x 150 under 50KB, signature image upload",
    sections: [
      ["Prepare the larger canvas", "Open the resizer with 400 x 150 pixels prefilled. Fit-inside mode keeps the complete signature visible and adds empty space if needed."],
      ["Compress carefully", "A larger signature can still fit under 50KB because it has simple colors, but review stroke quality after compression."],
      ["Use as a file helper", "This prepares a visual signature image for ordinary upload boxes. It does not verify identity, consent, legal signing authority, or portal acceptance."],
    ],
  }),
  exactSignatureUploadLandingPage({
    path: "signature-100x50-10kb",
    width: 100,
    height: 50,
    kb: 10,
    title: "Signature 100x50 Pixels Under 10KB",
    description: "Resize a tiny signature image to 100 x 50 pixels locally and compress it toward a strict 10KB upload cap.",
    headline: "Make a 100 x 50 px signature under 10KB",
    lead: "Use this when a form requires a very small 100 x 50 pixel signature image and rejects files above 10KB.",
    intent: "signature 100x50 10KB, resize signature 100 x 50 under 10KB, tiny signature upload",
    sections: [
      ["Use the tiny signature box", "Open the resizer with 100 x 50 pixels prefilled. Fit-inside mode keeps strokes visible and pads empty space instead of cropping."],
      ["Compress gently", "A 10KB cap is strict but simple signature images can fit. Reduce size after resizing and stop before strokes become unreadable."],
      ["Review stroke clarity", "Check for missing, broken, or pale strokes before using the image in a form. This is a visual helper, not identity verification."],
    ],
  }),
  exactSignatureUploadLandingPage({
    path: "signature-200x60-20kb",
    width: 200,
    height: 60,
    kb: 20,
    title: "Signature 200x60 Pixels Under 20KB",
    description: "Resize a signature image to 200 x 60 pixels locally and compress it toward a strict 20KB cap.",
    headline: "Make a 200 x 60 px signature under 20KB",
    lead: "Use this when a portal asks for a 200 x 60 pixel signature strip and a file below 20KB.",
    intent: "signature 200x60 20KB, resize signature 200 x 60 under 20KB, signature upload",
    sections: [
      ["Match 200 x 60 first", "Use the prefilled resizer to create the exact signature canvas before checking the file size."],
      ["Then target 20KB", "Compress the resized copy only if needed. Keep a backup of the original scan if the result becomes too faint."],
      ["Check the exported strip", "Make sure the signature is centered, complete, and readable before uploading it to the destination form."],
    ],
  }),
  exactSignatureUploadLandingPage({
    path: "signature-256x64-20kb",
    width: 256,
    height: 64,
    kb: 20,
    title: "Signature 256x64 Pixels Under 20KB",
    description: "Resize a signature image to 256 x 64 pixels locally and compress it toward a strict 20KB upload cap.",
    headline: "Make a 256 x 64 px signature under 20KB",
    lead: "Use this when an upload box names a 256 x 64 pixel signature image and a strict 20KB file limit.",
    intent: "signature 256x64 20KB, resize signature 256 x 64 under 20KB, signature image upload",
    sections: [
      ["Prepare the exact canvas", "Open the resizer with 256 x 64 pixels prefilled. Fit-inside mode preserves the full signature inside the required strip."],
      ["Compress after export", "Run the resized signature through the 20KB target only after dimensions are correct, then inspect the final image."],
      ["Avoid over-compression", "If strokes break or fade, return to the original scan and try a cleaner crop or transparent signature first."],
    ],
  }),
  exactSignatureUploadLandingPage({
    path: "signature-400x200-100kb",
    width: 400,
    height: 200,
    kb: 100,
    title: "Signature 400x200 Pixels Under 100KB",
    description: "Resize a large signature image to 400 x 200 pixels locally and compress it toward a 100KB upload cap.",
    headline: "Make a 400 x 200 px signature under 100KB",
    lead: "Use this when a form uses a large 400 x 200 pixel signature box and allows a wider 100KB file-size cap.",
    intent: "signature 400x200 100KB, resize signature 400 x 200 under 100KB, large signature upload",
    sections: [
      ["Use the larger signature canvas", "Open the resizer with 400 x 200 pixels ready. Fit-inside mode keeps the complete signature visible and pads the box if needed."],
      ["Preserve quality at 100KB", "A 100KB cap usually keeps a clear signature. Compress only if the exported image still exceeds the destination limit."],
      ["Review before upload", "Check for clipping, blur, background artifacts, and weak contrast. This helper prepares a file only and does not verify identity or consent."],
    ],
  }),
];
...
const landingPages = [
  ...
  {
    path: "pdf-must-be-under-100kb",
    title: "PDF Must Be Under 100KB Fix",
    description: "Fix a PDF must be under 100KB upload error with a local no-upload PDF compressor and fallback steps.",
    headline: "Fix PDF must be under 100KB",
    lead: "Use this when an exam portal, school form, admin site, or strict upload box rejects a PDF with a message like PDF must be under 100KB.",
    primaryTool: "tools/compress-pdf?targetSize=100kb",
    intent: "PDF must be under 100KB, compress PDF to 100KB, upload limit error",
    uploadErrorMatcher: true,
    sections: [
      ["Use the strictest PDF target", "Open the PDF compressor with the 100KB target selected. This is a severe limit and works best for one short scanned page or a simple form."],
      ["Expect quality tradeoffs", "A 100KB PDF cap can blur stamps, signatures, and small text. Keep the original and inspect the compressed copy before submitting it."],
      ["If it still fails", "Split the PDF to the required page, reduce source image dimensions, or convert the page to an image before rebuilding a smaller upload file."],
    ],
    relatedTools: ["tools/compress-pdf?targetSize=100kb", "tools/split-pdf", "tools/pdf-to-images"],
  },
  {
    path: "pdf-must-be-under-200kb",
    title: "PDF Must Be Under 200KB Fix",
    description: "Reduce a short PDF toward a 200KB upload limit locally when a portal says the PDF must be under 200KB.",
    headline: "Fix PDF must be under 200KB",
    lead: "Use this when a school, application, exam, or admin upload page rejects a PDF with a strict 200KB cap.",
    primaryTool: "tools/compress-pdf?targetSize=200kb",
    intent: "PDF must be under 200KB, compress PDF to 200KB, upload limit error",
    uploadErrorMatcher: true,
    sections: [
      ["Use the 200KB PDF target", "Open the PDF compressor with 200KB already selected. This target is meant for short scanned forms, receipts, certificates, or one-page documents."],
      ["Keep the file short", "Long PDFs or high-detail scans may not fit cleanly under 200KB. Compress only the required pages when the destination does not need the full document."],
      ["Review before upload", "Open the downloaded PDF and check small text, seals, signatures, and form fields before submitting it to the portal."],
    ],
    relatedTools: ["tools/compress-pdf?targetSize=200kb", "tools/split-pdf", "tools/compress-image-to-kb"],
  },
  {
    path: "pdf-must-be-under-300kb",
    title: "PDF Must Be Under 300KB Fix",
    description: "Compress a PDF locally toward a 300KB upload cap when an application, school, or admin portal rejects the file.",
    headline: "Fix PDF must be under 300KB",
    lead: "Use this when an upload page says the PDF must be under 300KB and you need a fast browser-side compression path before submitting.",
    primaryTool: "tools/compress-pdf?targetSize=300kb",
    intent: "PDF must be under 300KB, compress PDF to 300KB, upload limit error",
    uploadErrorMatcher: true,
    sections: [
      ["Use the 300KB PDF target", "Open the PDF compressor with the 300KB target selected. It gives slightly more room than 100KB or 200KB while still targeting strict upload caps."],
      ["Best for compact scans", "This works best for short scanned forms, IDs, certificates, or document pages where file size matters more than selectable text."],
      ["If quality drops", "Try splitting the PDF, reducing source photo size, or using a wider target if the portal allows it."],
    ],
    relatedTools: ["tools/compress-pdf?targetSize=300kb", "tools/pdf-to-images", "tools/split-pdf"],
  },
  {
  ...
  {
    path: "pdf-must-be-under-10mb",
    title: "PDF Must Be Under 10MB Fix",
    description: "Reduce a PDF locally toward a 10MB upload limit for email, support, application, and document portals.",
    headline: "Fix PDF must be under 10 MB",
    lead: "Use this when a site accepts PDF files but rejects yours because the PDF must be under 10 MB. Start with the 10MB PDF target so the file can stay readable while getting smaller.",
    primaryTool: "tools/compress-pdf?targetSize=10mb",
    intent: "PDF must be under 10MB, compress PDF to 10MB, upload PDF too large",
    uploadErrorMatcher: true,
    sections: [
      ["Use the 10MB PDF target", "Open the PDF compressor with the 10MB target. This is useful for support tickets, applications, and email-style portals that reject large scans but allow readable files."],
      ["Preserve detail when possible", "A 10MB cap is wider than tiny KB limits, so it usually gives scanned pages, signatures, and stamps more room to stay clear."],
      ["Check before submitting", "Open the smaller file and confirm every page is present and readable before uploading it to the destination website."],
    ],
    relatedTools: ["tools/compress-pdf?targetSize=10mb", "tools/pdf-to-images", "tools/merge-pdf"],
  },
  {
  ...
  },
  {
    ...
    targetLinks: [
      ["PDF must be under 100KB", "pdf-must-be-under-100kb", "For exam, school, and strict admin upload errors that name a 100KB PDF cap."],
      ["PDF must be under 200KB", "pdf-must-be-under-200kb", "For severe PDF upload errors on short scanned forms and one-page documents."],
      ["PDF must be under 300KB", "pdf-must-be-under-300kb", "For strict PDF upload errors with slightly more room than 100KB or 200KB."],
      ...
      ["PDF must be under 10MB", "pdf-must-be-under-10mb", "For email, support, and document portals that name a 10MB PDF cap."],
  ...
  },
  {
    ...
    relatedTools: ["tools/compress-pdf?targetSize=200kb", "tools/pdf-to-images", "tools/compress-image-to-kb"],
  },
  {
  ...
  },
  {
    ...
    relatedTools: ["tools/compress-pdf?targetSize=500kb", "tools/pdf-to-images", "tools/compress-image-to-kb"],
  },
  {
  ...
  },
  {
    ...
    relatedTools: ["tools/compress-pdf?targetSize=5mb", "tools/pdf-to-images", "tools/merge-pdf"],
  },
  {
  ...
  {
    path: "photo-200x230-20kb",
    title: "Photo 200x230 Pixels Under 20KB",
    description: "Resize a strict application, exam, or ID-style photo to 200 x 230 pixels locally before compressing toward a 20KB upload cap.",
    headline: "Make a 200 x 230 px photo under 20KB",
    lead: "Use this when a portal rejects a photo unless it is exactly 200 x 230 pixels and below a tiny 20KB file-size limit. Resize first, then compress the exported result toward 20KB.",
    primaryTool: "tools/resize-image?width=200&height=230&fit=cover",
    intent: "photo 200x230 20KB, resize photo 200 x 230 under 20KB, exam photo upload",
    sections: [
      ["Resize before compression", "Exact dimension checks usually run before file-size checks. Create the 200 x 230 pixel photo first so the receiving portal does not reject the image for width or height."],
      ["Then use the 20KB target", "A 20KB cap is very strict. After resizing, open the image-to-KB compressor with a 20KB target and expect some softness in face, hair, and background detail."],
      ["Review before submitting", "Open the final image and compare it with the destination notice. This local helper does not guarantee acceptance by any exam, job, visa, school, or government portal."],
    ],
    serviceLead: uploadLimitLandingServiceLead("make a 200 x 230 px photo under 20KB"),
    relatedTools: ["tools/resize-image?width=200&height=230&fit=cover", "tools/compress-image-to-kb?targetKb=20", "tools/passport-photo", "tools/crop-image"],
  },
  {
    path: "photo-200x230-100kb",
    title: "Photo 200x230 Pixels Under 100KB",
    description: "Resize a 200 x 230 pixel photo locally and compress it toward a 100KB application, profile, or exam upload cap.",
    headline: "Make a 200 x 230 px photo under 100KB",
    lead: "Use this when a form names both the exact 200 x 230 pixel photo size and a 100KB file limit. Start with the prefilled resizer, then compress only if the exported file is still too large.",
    primaryTool: "tools/resize-image?width=200&height=230&fit=cover",
    intent: "photo 200x230 100KB, resize photo 200 x 230 under 100KB, application photo size",
    sections: [
      ["Match dimensions first", "Use the 200 x 230 pixel resizer before worrying about file size. Many upload forms reject wrong dimensions even when the file is already small."],
      ["Compress only if needed", "A 100KB cap usually keeps more detail than 20KB or 50KB. If the resized image is still too large, run it through the image-to-KB compressor with 100KB selected."],
      ["Check face placement", "Cover mode crops to fill the target box. If face placement matters, crop or use the passport photo tool first, then resize and compress."],
    ],
    serviceLead: uploadLimitLandingServiceLead("make a 200 x 230 px photo under 100KB"),
    relatedTools: ["tools/resize-image?width=200&height=230&fit=cover", "tools/compress-image-to-kb?targetKb=100", "tools/passport-photo", "tools/crop-image"],
  },
  {
    path: "photo-240x320-50kb",
    ...
    primaryTool: "tools/resize-image?width=240&height=320&fit=cover",
    ...
    relatedTools: ["tools/resize-image?width=240&height=320&fit=cover", "tools/compress-image-to-kb?targetKb=50", "tools/passport-photo", "tools/crop-image"],
  },
  {
    path: "photo-413x531-100kb",
    title: "Photo 413x531 Pixels Under 100KB",
    description: "Resize an ID-style or application photo to 413 x 531 pixels locally and compress it toward a 100KB upload cap.",
    headline: "Make a 413 x 531 px photo under 100KB",
    lead: "Use this when a portal asks for an exact 413 x 531 pixel photo and rejects larger files above 100KB. Resize to the exact dimensions first, then compress the result if needed.",
    primaryTool: "tools/resize-image?width=413&height=531&fit=cover",
    intent: "photo 413x531 100KB, resize photo 413 x 531 under 100KB, ID photo upload",
    sections: [
      ["Use the exact 413 x 531 preset", "The linked resizer opens with 413 x 531 pixels ready. This is useful for forms that validate dimensions before accepting the file."],
      ["Then target 100KB", "After exporting the resized photo, use image-to-KB with a 100KB target if the receiving website still says the file is too large."],
    ...
    relatedTools: ["tools/resize-image?width=413&height=531&fit=cover", "tools/compress-image-to-kb?targetKb=100", "tools/passport-photo", "tools/crop-image"],
  },
  {
    path: "photo-413x531-50kb",
    ...
    relatedTools: ["tools/resize-image?width=413&height=531&fit=cover", "tools/compress-image-to-kb?targetKb=50", "tools/passport-photo", "tools/crop-image"],
  },
  {
    path: "photo-300x300-100kb",
    ...
    primaryTool: "tools/resize-image?width=300&height=300&fit=cover",
    ...
    relatedTools: ["tools/resize-image?width=300&height=300&fit=cover", "tools/compress-image-to-kb?targetKb=100", "tools/passport-photo", "tools/crop-image"],
  },
  {
    path: "photo-600x600-100kb",
    ...
    relatedTools: ["tools/resize-image?width=600&height=600&fit=cover", "tools/compress-image-to-kb?targetKb=100", "tools/passport-photo", "tools/crop-image"],
  },
  ...ADDITIONAL_EXACT_PHOTO_UPLOAD_PAGES,
  {
  ...
  {
    path: "signature-140x60-20kb",
    title: "Signature 140x60 Pixels Under 20KB",
    description: "Resize a signature image to 140 x 60 pixels locally and compress it toward a strict 20KB upload limit.",
    headline: "Make a 140 x 60 px signature under 20KB",
    lead: "Use this when a form, exam portal, bank-style upload, or admin page asks for a signature image that is exactly 140 x 60 pixels and below 20KB.",
    primaryTool: "tools/resize-image?width=140&height=60&fit=contain",
    intent: "signature 140x60 20KB, resize signature 140 x 60 under 20KB, signature upload",
    sections: [
      ["Resize first", "Open the image resizer with 140 x 60 pixels prefilled. Fit-inside mode keeps the full signature visible instead of cutting off strokes."],
      ["Compress the resized copy", "After the dimensions match, run the exported image through the image-to-KB compressor with a 20KB target if the portal also enforces file size."],
      ["Check the signature line", "Make sure strokes are not cropped, broken, or too faint. This creates a visual signature image only and does not verify identity or consent."],
    ],
    serviceLead: uploadLimitLandingServiceLead("make a 140 x 60 px signature under 20KB"),
    relatedTools: ["tools/resize-image?width=140&height=60&fit=contain", "tools/compress-image-to-kb?targetKb=20", "tools/signature-png", "tools/remove-background"],
  },
  {
    path: "signature-140x60-50kb",
    title: "Signature 140x60 Pixels Under 50KB",
    description: "Resize a signature image to 140 x 60 pixels locally and compress it toward a 50KB upload cap.",
    headline: "Make a 140 x 60 px signature under 50KB",
    lead: "Use this when a portal gives a 140 x 60 pixel signature box and a 50KB file-size cap. Resize first, then compress only if the exported signature is still too large.",
    primaryTool: "tools/resize-image?width=140&height=60&fit=contain",
    intent: "signature 140x60 50KB, resize signature 140 x 60 under 50KB, signature image size",
    sections: [
      ["Match the signature box", "Use the 140 x 60 pixel resizer before checking the KB size. A correct file size will still fail if the signature dimensions are wrong."],
      ["Use the 50KB target", "A 50KB limit usually preserves a clearer signature than 20KB. Compress the resized copy with the 50KB target if needed."],
      ["Keep it readable", "Review the exported image for missing strokes, heavy blur, or accidental cropping before uploading it to the destination form."],
    ],
    serviceLead: uploadLimitLandingServiceLead("make a 140 x 60 px signature under 50KB"),
    relatedTools: ["tools/resize-image?width=140&height=60&fit=contain", "tools/compress-image-to-kb?targetKb=50", "tools/signature-png", "tools/crop-image"],
  },
  {
    path: "signature-150x50-20kb",
    ...
    primaryTool: "tools/resize-image?width=150&height=50&fit=contain",
    ...
    relatedTools: ["tools/resize-image?width=150&height=50&fit=contain", "tools/compress-image-to-kb?targetKb=20", "tools/signature-png", "tools/remove-background"],
  },
  {
    path: "signature-200x50-20kb",
    ...
    primaryTool: "tools/resize-image?width=200&height=50&fit=contain",
    ...
    relatedTools: ["tools/resize-image?width=200&height=50&fit=contain", "tools/compress-image-to-kb?targetKb=20", "tools/signature-png", "tools/crop-image"],
  },
  {
    path: "signature-200x100-50kb",
    title: "Signature 200x100 Pixels Under 50KB",
    description: "Resize a signature image to 200 x 100 pixels locally and compress it toward a 50KB upload cap.",
    headline: "Make a 200 x 100 px signature under 50KB",
    lead: "Use this when a wider signature upload box requires exactly 200 x 100 pixels and the file must stay below 50KB.",
    primaryTool: "tools/resize-image?width=200&height=100&fit=contain",
    intent: "signature 200x100 50KB, resize signature 200 x 100 under 50KB, signature upload",
    sections: [
      ["Use the wider signature preset", "Open the resizer with 200 x 100 pixels prefilled. Fit-inside mode keeps the whole signature visible and pads the empty space if needed."],
      ["Compress after resizing", "If the exported signature is above the portal cap, use the image-to-KB compressor with a 50KB target and keep the original scan as a backup."],
  ...
  },
  {
    ...
    primaryTool: "tools/resize-image?width=300&height=80&fit=contain",
    ...
    relatedTools: ["tools/resize-image?width=300&height=80&fit=contain", "tools/compress-image-to-kb?targetKb=50", "tools/signature-png", "tools/crop-image"],
  },
  {
    path: "signature-300x100-50kb",
    ...
    primaryTool: "tools/resize-image?width=300&height=100&fit=contain",
    ...
    relatedTools: ["tools/resize-image?width=300&height=100&fit=contain", "tools/compress-image-to-kb?targetKb=50", "tools/signature-png", "tools/crop-image"],
  },
  ...ADDITIONAL_EXACT_SIGNATURE_UPLOAD_PAGES,
  {
...
function directorySubmissionHtml() {
  ...
  const freenosignupUploadFixListings = [
    ...
    ["FreeNoSignup Photo 150x200 Under 20KB", "https://freenosignup.com/?s=Photo+150x200+Under+20KB", "Pending Google Form submission for the exact 150 x 200 px and 20KB photo path."],
    ["FreeNoSignup Photo 180x240 Under 50KB", "https://freenosignup.com/?s=Photo+180x240+Under+50KB", "Pending Google Form submission for the exact 180 x 240 px and 50KB photo path."],
    ["FreeNoSignup Photo 400x514 Under 100KB", "https://freenosignup.com/?s=Photo+400x514+Under+100KB", "Pending Google Form submission for the exact 400 x 514 px and 100KB photo path."],
    ["FreeNoSignup Photo 600x800 Under 200KB", "https://freenosignup.com/?s=Photo+600x800+Under+200KB", "Pending Google Form submission for the exact 600 x 800 px and 200KB photo path."],
    ...
    ["FreeNoSignup Signature 100x50 Under 10KB", "https://freenosignup.com/?s=Signature+100x50+Under+10KB", "Pending Google Form submission for the exact 100 x 50 px and 10KB signature path."],
    ["FreeNoSignup Signature 200x60 Under 20KB", "https://freenosignup.com/?s=Signature+200x60+Under+20KB", "Pending Google Form submission for the exact 200 x 60 px and 20KB signature path."],
    ["FreeNoSignup Signature 256x64 Under 20KB", "https://freenosignup.com/?s=Signature+256x64+Under+20KB", "Pending Google Form submission for the exact 256 x 64 px and 20KB signature path."],
    ["FreeNoSignup Signature 400x200 Under 100KB", "https://freenosignup.com/?s=Signature+400x200+Under+100KB", "Pending Google Form submission for the exact 400 x 200 px and 100KB signature path."],
  ...
  const liveDirectoryListings = [
    ...
    ["NoSignupTools Photo 150x200 Under 20KB", "https://nosignuptools.com/tools/photo-150x200-under-20kb-by-printabletools-lab", "Pending public API submission for the combined 150 x 200 px and 20KB photo path."],
    ["NoSignupTools Photo 180x240 Under 50KB", "https://nosignuptools.com/tools/photo-180x240-under-50kb-by-printabletools-lab", "Pending public API submission for the combined 180 x 240 px and 50KB photo path."],
    ["NoSignupTools Photo 400x514 Under 100KB", "https://nosignuptools.com/tools/photo-400x514-under-100kb-by-printabletools-lab", "Pending public API submission for the combined 400 x 514 px and 100KB photo path."],
    ["NoSignupTools Photo 600x800 Under 200KB", "https://nosignuptools.com/tools/photo-600x800-under-200kb-by-printabletools-lab", "Pending public API submission for the combined 600 x 800 px and 200KB photo path."],
    ...
    ["NoSignupTools Signature 100x50 Under 10KB", "https://nosignuptools.com/tools/signature-100x50-under-10kb-by-printabletools-lab", "Pending public API submission for the exact 100 x 50 px and 10KB signature path."],
    ["NoSignupTools Signature 200x60 Under 20KB", "https://nosignuptools.com/tools/signature-200x60-under-20kb-by-printabletools-lab", "Pending public API submission for the exact 200 x 60 px and 20KB signature path."],
    ["NoSignupTools Signature 256x64 Under 20KB", "https://nosignuptools.com/tools/signature-256x64-under-20kb-by-printabletools-lab", "Pending public API submission for the exact 256 x 64 px and 20KB signature path."],
    ["NoSignupTools Signature 400x200 Under 100KB", "https://nosignuptools.com/tools/signature-400x200-under-100kb-by-printabletools-lab", "Pending public API submission for the exact 400 x 200 px and 100KB signature path."],
    ...
    ["NoSignupTools Compress Image to 10KB", "https://nosignuptools.com/tools/compress-image-to-10kb-by-printabletools-lab", "Pending public API submission for the exact 10KB image upload-limit path."],
    ["NoSignupTools Compress Image to 20KB", "https://nosignuptools.com/tools/compress-image-to-20kb-by-printabletools-lab", "Pending public API submission for the exact 20KB image upload-limit path."],
    ["NoSignupTools Compress Image to 30KB", "https://nosignuptools.com/tools/compress-image-to-30kb-by-printabletools-lab", "Pending public API submission for the exact 30KB image upload-limit path."],
    ["NoSignupTools Compress Image to 150KB", "https://nosignuptools.com/tools/compress-image-to-150kb-by-printabletools-lab", "Pending public API submission for the exact 150KB image upload-limit path."],
    ["NoSignupTools Compress Image to 300KB", "https://nosignuptools.com/tools/compress-image-to-300kb-by-printabletools-lab", "Pending public API submission for the exact 300KB image upload-limit path."],
    ["NoSignupTools Compress Image to 500KB", "https://nosignuptools.com/tools/compress-image-to-500kb-by-printabletools-lab", "Pending public API submission for the exact 500KB image upload-limit path."],
    ["NoSignupTools Compress PDF to 500KB", "https://nosignuptools.com/tools/compress-pdf-to-500kb-by-printabletools-lab", "Pending public API submission for the exact 500KB PDF upload-limit path."],
    ["NoSignupTools Compress PDF to 1MB", "https://nosignuptools.com/tools/compress-pdf-to-1mb-by-printabletools-lab", "Pending public API submission for the exact 1MB PDF upload-limit path."],
    ["NoSignupTools Compress PDF to 2MB", "https://nosignuptools.com/tools/compress-pdf-to-2mb-by-printabletools-lab", "Pending public API submission for the exact 2MB PDF upload-limit path."],
    ["NoSignupTools Compress PDF to 5MB", "https://nosignuptools.com/tools/compress-pdf-to-5mb-by-printabletools-lab", "Pending public API submission for the exact 5MB PDF upload-limit path."],
    ["NoSignupTools PDF Size Reducer", "https://nosignuptools.com/tools/pdf-size-reducer-by-printabletools-lab", "Pending public API submission for the PDF size reducer hub."],
    ["NoSignupTools File Must Be Less Than 1MB Fix", "https://nosignuptools.com/tools/file-must-be-less-than-1mb-fix-by-printabletools-lab", "Pending public API submission for the file under 1MB upload-error path."],
    ["NoSignupTools PDF Must Be Under 500KB Fix", "https://nosignuptools.com/tools/pdf-must-be-under-500kb-fix-by-printabletools-lab", "Pending public API submission for the PDF under 500KB upload-error path."],
    ["NoSignupTools Photo Must Be Under 100KB Fix", "https://nosignuptools.com/tools/photo-must-be-under-100kb-fix-by-printabletools-lab", "Pending public API submission for the photo under 100KB upload-error path."],
    ["NoSignupTools Image Must Be Under 500KB Fix", "https://nosignuptools.com/tools/image-must-be-under-500kb-fix-by-printabletools-lab", "Pending public API submission for the image under 500KB upload-error path."],
    ["NoSignupTools Image Must Be Less Than 2MB Fix", "https://nosignuptools.com/tools/image-must-be-less-than-2mb-fix-by-printabletools-lab", "Pending public API submission for the image under 2MB upload-error path."],
    ["NoSignupTools JPG Must Be Under 200KB Fix", "https://nosignuptools.com/tools/jpg-must-be-under-200kb-fix-by-printabletools-lab", "Pending public API submission for the JPG under 200KB upload-error path."],
