...
const UPLOAD_ERROR_CHEATSHEET = [
  ...
  },
  {
    ...
    landingPath: "compress-pdf-to-100kb",
    toolPath: "tools/compress-pdf?targetSize=100kb",
    response: "Use the strictest 100KB PDF target and review readability before submitting.",
    format: "PDF",
    target: "100KB",
  },
  {
    ...
    landingPath: "compress-pdf-to-200kb",
    toolPath: "tools/compress-pdf?targetSize=200kb",
    response: "Use the severe 200KB PDF target for short scanned forms and keep the original nearby.",
    format: "PDF",
    target: "200KB",
  },
  {
    ...
    landingPath: "compress-pdf-to-300kb",
    toolPath: "tools/compress-pdf?targetSize=300kb",
    response: "Use the 300KB PDF target when the portal allows a little more detail than 100KB or 200KB.",
    format: "PDF",
    target: "300KB",
  },
  {
  ...
  },
  {
    ...
    landingPath: "compress-pdf-to-10mb",
    toolPath: "tools/compress-pdf?targetSize=10mb",
    response: "Use the 10MB PDF target for wider caps that still reject very large scans.",
    format: "PDF",
    target: "10MB",
  },
  {
