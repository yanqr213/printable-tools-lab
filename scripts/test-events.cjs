...
async function main() {
  ...
  assert(metricsPayload.tools.length === 38, "Metrics should include every active tool");
  ...
  for (const tool of ["multi-image-pdf", "merge-pdf", "split-pdf", "pdf-page-numbers", "text-to-pdf", "receipt-generator", "timesheet-generator", "business-card", "address-labels", "barcode-labels", "price-tag", "flyer-maker", "coupon-maker", "packing-slip", "work-order", "inventory-sheet", "certificate-generator", "todo-list"]) {
