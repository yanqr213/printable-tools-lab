...
const latestExactUploadLimitBacklog = [
  ["compress-pdf-to-100kb", "Compress PDF to 100KB", "pdf_100kb_2026_06", "compress_pdf_to_100kb_landing", "Free no-signup PDF compressor for very strict 100KB upload limits.", "PrintableTools Lab Compress PDF to 100KB helps people blocked by forms, exam portals, school uploads, and application pages with very strict 100KB PDF caps. The page opens the browser PDF compressor with the 100KB target selected, keeps ordinary files local, and includes an optional public-safe $9 Upload Limit Fix Plan request after fit is confirmed."],
  ["compress-pdf-to-200kb", "Compress PDF to 200KB", "pdf_200kb_2026_06", "compress_pdf_to_200kb_landing", "Free no-signup PDF compressor for strict 200KB upload limits.", "PrintableTools Lab Compress PDF to 200KB helps people blocked by application, exam, school, and admin upload pages with strict 200KB PDF caps. The page opens the browser PDF compressor with the 200KB target selected, keeps ordinary files local, and includes an optional public-safe $9 Upload Limit Fix Plan request after fit is confirmed."],
  ["compress-pdf-to-300kb", "Compress PDF to 300KB", "pdf_300kb_2026_06", "compress_pdf_to_300kb_landing", "Free no-signup PDF compressor for strict 300KB upload limits.", "PrintableTools Lab Compress PDF to 300KB helps people blocked by portal and form upload limits that need slightly more readable detail than 100KB or 200KB. The page opens the browser PDF compressor with the 300KB target selected, keeps ordinary files local, and includes an optional public-safe $9 Upload Limit Fix Plan request after fit is confirmed."],
  ["compress-pdf-to-10mb", "Compress PDF to 10MB", "pdf_10mb_2026_06", "compress_pdf_to_10mb_landing", "Free no-signup PDF compressor for wider 10MB upload limits.", "PrintableTools Lab Compress PDF to 10MB helps people blocked by email, support, school, document, and portal upload limits that still reject large scans. The page opens the browser PDF compressor with the 10MB target selected, keeps ordinary files local, and includes an optional public-safe $9 Upload Limit Fix Plan request after fit is confirmed."],
  ["pdf-must-be-under-100kb", "PDF Must Be Under 100KB Fix", "pdf_under_100kb_upload_fix_2026_06", "pdf_must_be_under_100kb_landing", "Free no-signup PDF under 100KB upload-error fix.", "PrintableTools Lab PDF Must Be Under 100KB Fix helps people blocked by exact PDF must be under 100KB errors on forms, exam portals, school uploads, and application pages. The page routes visitors to local browser PDF compression with the 100KB target selected and includes an optional public-safe $9 Upload Limit Fix Plan request without asking for private files, IDs, logins, or payment details."],
  ["pdf-must-be-under-200kb", "PDF Must Be Under 200KB Fix", "pdf_under_200kb_upload_fix_2026_06", "pdf_must_be_under_200kb_landing", "Free no-signup PDF under 200KB upload-error fix.", "PrintableTools Lab PDF Must Be Under 200KB Fix helps people blocked by exact PDF must be under 200KB errors on application, school, exam, and admin upload pages. The page routes visitors to local browser PDF compression with the 200KB target selected and includes an optional public-safe $9 Upload Limit Fix Plan request without asking for private files, IDs, logins, or payment details."],
  ["pdf-must-be-under-300kb", "PDF Must Be Under 300KB Fix", "pdf_under_300kb_upload_fix_2026_06", "pdf_must_be_under_300kb_landing", "Free no-signup PDF under 300KB upload-error fix.", "PrintableTools Lab PDF Must Be Under 300KB Fix helps people blocked by exact PDF must be under 300KB errors where the document needs a little more readable detail than tiny 100KB or 200KB caps. The page routes visitors to local browser PDF compression with the 300KB target selected and includes an optional public-safe $9 Upload Limit Fix Plan request without asking for private files, IDs, logins, or payment details."],
  ["pdf-must-be-under-10mb", "PDF Must Be Under 10MB Fix", "pdf_under_10mb_upload_fix_2026_06", "pdf_must_be_under_10mb_landing", "Free no-signup PDF under 10MB upload-error fix.", "PrintableTools Lab PDF Must Be Under 10MB Fix helps people blocked by exact PDF must be under 10MB errors on email, support, school, document, and portal upload pages. The page routes visitors to local browser PDF compression with the 10MB target selected and includes an optional public-safe $9 Upload Limit Fix Plan request without asking for private files, IDs, logins, or payment details."],
  ["photo-120x160-20kb", "Photo 120x160 Under 20KB", "photo_120x160_20kb_2026_06", "photo_120x160_20kb_landing", "Free no-signup 120 x 160 photo and strict 20KB upload workflow.", "PrintableTools Lab Photo 120x160 Under 20KB helps people blocked by exam, school, application, and profile forms that require exact 120 x 160 px portrait dimensions plus a tiny 20KB cap. The page points visitors through local browser resize and image-to-KB steps, then offers an optional public-safe $9 Upload Limit Fix Plan request without asking for private files, IDs, logins, or payment details."],
  ["photo-160x200-30kb", "Photo 160x200 Under 30KB", "photo_160x200_30kb_2026_06", "photo_160x200_30kb_landing", "Free no-signup 160 x 200 photo and strict 30KB upload workflow.", "PrintableTools Lab Photo 160x200 Under 30KB helps people blocked by forms that require exact 160 x 200 px portrait dimensions plus a 30KB file-size cap. The page points visitors through local browser resize and image-to-KB steps, then offers an optional public-safe $9 Upload Limit Fix Plan request without asking for private files, IDs, logins, or payment details."],
  ["photo-300x400-100kb", "Photo 300x400 Under 100KB", "photo_300x400_100kb_2026_06", "photo_300x400_100kb_landing", "Free no-signup 300 x 400 photo and 100KB upload workflow.", "PrintableTools Lab Photo 300x400 Under 100KB helps people blocked by application, profile, school, and admin upload forms that require exact 300 x 400 px portrait dimensions plus a 100KB cap. The page points visitors through local browser resize and compression steps, then offers an optional public-safe $9 Upload Limit Fix Plan request without asking for private files, IDs, logins, or payment details."],
  ["photo-350x450-100kb", "Photo 350x450 Under 100KB", "photo_350x450_100kb_2026_06", "photo_350x450_100kb_landing", "Free no-signup 350 x 450 photo and 100KB upload workflow.", "PrintableTools Lab Photo 350x450 Under 100KB helps people blocked by ID-style, application, school, profile, and admin upload forms that require exact 350 x 450 px portrait dimensions plus a 100KB cap. The page points visitors through local browser resize and compression steps, then offers an optional public-safe $9 Upload Limit Fix Plan request without asking for private files, IDs, logins, or payment details."],
  ["photo-360x480-100kb", "Photo 360x480 Under 100KB", "photo_360x480_100kb_2026_06", "photo_360x480_100kb_landing", "Free no-signup 360 x 480 photo and 100KB upload workflow.", "PrintableTools Lab Photo 360x480 Under 100KB helps people blocked by application, profile, school, and admin upload forms that require exact 360 x 480 px portrait dimensions plus a 100KB cap. The page points visitors through local browser resize and compression steps, then offers an optional public-safe $9 Upload Limit Fix Plan request without asking for private files, IDs, logins, or payment details."],
  ["photo-420x560-200kb", "Photo 420x560 Under 200KB", "photo_420x560_200kb_2026_06", "photo_420x560_200kb_landing", "Free no-signup 420 x 560 photo and 200KB upload workflow.", "PrintableTools Lab Photo 420x560 Under 200KB helps people blocked by application, profile, school, marketplace, and admin upload forms that require exact 420 x 560 px portrait dimensions plus a 200KB cap. The page points visitors through local browser resize and compression steps, then offers an optional public-safe $9 Upload Limit Fix Plan request without asking for private files, IDs, logins, or payment details."],
  ...
  ["photo-150x200-20kb", "Photo 150x200 Under 20KB", "photo_150x200_20kb_2026_06", "photo_150x200_20kb_landing", "Free no-signup 150 x 200 photo and strict 20KB upload workflow.", "PrintableTools Lab Photo 150x200 Under 20KB helps people blocked by application, school, exam, profile, and admin upload forms that require exact 150 x 200 px portrait dimensions plus a tiny 20KB cap. The page points visitors through local browser resize and image-to-KB steps, then offers an optional public-safe $9 Upload Limit Fix Plan request without asking for private files, IDs, logins, or payment details."],
  ["photo-180x240-50kb", "Photo 180x240 Under 50KB", "photo_180x240_50kb_2026_06", "photo_180x240_50kb_landing", "Free no-signup 180 x 240 photo and 50KB upload workflow.", "PrintableTools Lab Photo 180x240 Under 50KB helps people blocked by application, profile, school, exam, and admin upload forms that require exact 180 x 240 px portrait dimensions plus a 50KB cap. The page points visitors through local browser resize and image-to-KB steps, then offers an optional public-safe $9 Upload Limit Fix Plan request without asking for private files, IDs, logins, or payment details."],
  ["photo-400x514-100kb", "Photo 400x514 Under 100KB", "photo_400x514_100kb_2026_06", "photo_400x514_100kb_landing", "Free no-signup 400 x 514 photo and 100KB upload workflow.", "PrintableTools Lab Photo 400x514 Under 100KB helps people blocked by application, profile, document, and admin upload forms that require exact 400 x 514 px portrait dimensions plus a 100KB file-size cap. The page points visitors through local browser resize and compression steps, then offers an optional public-safe $9 Upload Limit Fix Plan request without asking for private files, IDs, logins, or payment details."],
  ["photo-600x800-200kb", "Photo 600x800 Under 200KB", "photo_600x800_200kb_2026_06", "photo_600x800_200kb_landing", "Free no-signup 600 x 800 photo and 200KB upload workflow.", "PrintableTools Lab Photo 600x800 Under 200KB helps people blocked by application, profile, school, marketplace, and admin upload forms that require exact 600 x 800 px portrait dimensions plus a 200KB file-size cap. The page points visitors through local browser resize and compression steps, then offers an optional public-safe $9 Upload Limit Fix Plan request without asking for private files, IDs, logins, or payment details."],
  ["signature-100x50-10kb", "Signature 100x50 Under 10KB", "signature_100x50_10kb_2026_06", "signature_100x50_10kb_landing", "Free no-signup 100 x 50 signature and strict 10KB upload workflow.", "PrintableTools Lab Signature 100x50 Under 10KB helps people blocked when an exam, job, school, bank, or admin upload page requires both an exact 100 x 50 px signature image and a tiny 10KB cap. The page opens browser resize and compression steps, keeps ordinary files local, and includes an optional public-safe $9 Upload Limit Fix Plan request after fit is confirmed."],
  ["signature-200x60-20kb", "Signature 200x60 Under 20KB", "signature_200x60_20kb_2026_06", "signature_200x60_20kb_landing", "Free no-signup 200 x 60 signature and strict 20KB upload workflow.", "PrintableTools Lab Signature 200x60 Under 20KB helps people blocked when an application, exam, job, school, bank, or admin upload page requires both an exact 200 x 60 px signature image and a strict 20KB cap. The page opens browser resize and compression steps, keeps ordinary files local, and includes an optional public-safe $9 Upload Limit Fix Plan request after fit is confirmed."],
  ["signature-256x64-20kb", "Signature 256x64 Under 20KB", "signature_256x64_20kb_2026_06", "signature_256x64_20kb_landing", "Free no-signup 256 x 64 signature and strict 20KB upload workflow.", "PrintableTools Lab Signature 256x64 Under 20KB helps people blocked when a portal requires both an exact 256 x 64 px signature image and a strict 20KB cap. The page opens browser resize and compression steps, keeps ordinary files local, and includes an optional public-safe $9 Upload Limit Fix Plan request after fit is confirmed."],
  ["signature-400x200-100kb", "Signature 400x200 Under 100KB", "signature_400x200_100kb_2026_06", "signature_400x200_100kb_landing", "Free no-signup 400 x 200 signature and 100KB upload workflow.", "PrintableTools Lab Signature 400x200 Under 100KB helps people blocked when a document, job, school, bank, or admin upload page requires both an exact 400 x 200 px signature image and a 100KB cap. The page opens browser resize and compression steps, keeps ordinary files local, and includes an optional public-safe $9 Upload Limit Fix Plan request after fit is confirmed."],
];
