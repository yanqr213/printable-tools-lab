...
const priorityMainUrls = [
  ...
  siteUrl("photo-120x160-20kb"),
  siteUrl("photo-160x200-30kb"),
  siteUrl("photo-300x400-100kb"),
  siteUrl("photo-350x450-100kb"),
  siteUrl("photo-360x480-100kb"),
  siteUrl("photo-420x560-200kb"),
