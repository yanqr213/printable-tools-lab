...
1. Keep the free tool site as the main zero-cash product because it already works, has 232 indexable routes, and can collect search/direct/referral data without app-store review.
