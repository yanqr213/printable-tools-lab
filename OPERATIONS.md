...
- `2026-06-09`: NoSignupTools accepted the `Image Dimensions 600x600 Upload Fix` and `PDF Not Accepted JPG Required Fix` high-intent tool-page submissions through the public API; monitor both as pending until public listings appear.
